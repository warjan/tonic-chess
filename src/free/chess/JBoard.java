...
public class JBoard extends JComponent{
  ...
  private ArrayList paintHooks = null;
  ...
  protected void drawArrow(Graphics g, Square from, Square to, int arrowSize, Color color){
    ...
    //g2d.drawString(String.valueOf(fromRect.x)+ "," + String.valueOf(fromRect.y), fromRect.x, fromRect.y);
    //g2d.drawString(String.valueOf(toRect.x)+ "," + String.valueOf(toRect.y), toRect.x-20, toRect.y-20);

    double angle = Math.atan2(toY - fromY, toX - fromX);

    //Dimension of rectangle where drawing occurs.
    //int height = Math.abs(fromRect.y - (toRect.y))+toRect.width;
    //int width = Math.abs(fromRect.x - (toRect.x))+toRect.height;

    //BufferedImage buffArrow = new BufferedImage(width, height, BufferedImage.TYPE_4BYTE_ABGR);
    //Graphics2D bag2d = buffArrow.createGraphics();
    ...
    int toXstick = toX - (int)(cos*toRect.width/6);
    
    toYstick = toY - (int)(sin*toRect.height/6);
    ...
    /*
    // The arrow "stick"
    xpoints[0] = (int)(fromX + sin*arrowSize);
    ypoints[0] = (int)(fromY - cos*arrowSize);
    
    
    xpoints[1] = (int)(fromX - sin*arrowSize);
    ypoints[1] = (int)(fromY + cos*arrowSize);
    xpoints[2] = (int)(toXstick-sin*arrowSize);
    ypoints[2] = (int)(toYstick + cos*arrowSize);
    xpoints[3] = (int)(toXstick + sin*arrowSize);
    ypoints[3] = (int)(toYstick - cos*arrowSize);
    g2d.setPaint(new Color(0.67f, 0.4f, 0.34f, 0.55f));
    g2d.fillPolygon(xpoints, ypoints, 4);
    g2d.setPaint(new Color(0.67f, 0.4f, 0.34f));
    g2d.drawPolygon(xpoints, ypoints, 4);
    g2d.setPaint(new Color(0,0,0));
    for (int i = 0; i < xpoints.length; i++){	
    	g2d.drawString(String.valueOf(i+1), xpoints[i], ypoints[i]);
    }
    int xpoints2[] = new int[3];
    int ypoints2[] = new int[3];

    // The arrow "point"
    xpoints2[0] = (int)(toX+cos*arrowSize);
    ypoints2[0] = (int)(toY+sin*arrowSize);
    xpoints2[1] = (int)(toX+Math.cos(angle-Math.PI*3/4)*arrowSize*3);
    ypoints2[1] = (int)(toY+Math.sin(angle-Math.PI*3/4)*arrowSize*3);
    //xpoints[2] = (int)(toX-cos*arrowSize);
    //ypoints[2] = (int)(toY-sin*arrowSize);
    xpoints2[2] = (int)(toX+Math.cos(angle+Math.PI*3/4)*arrowSize*3);
    ypoints2[2] = (int)(toY+Math.sin(angle+Math.PI*3/4)*arrowSize*3);
    for (int i = 0; i < xpoints.length; i++){
    	g2d.drawString(String.valueOf(i+1), xpoints[i]+10, ypoints[i]+10);
    }
    g2d.setPaint(new Color(0.67f, 0.4f, 0.34f, 0.55f));
    ...
    */
    ...
    xpoints[0] = (int)(fromX + sin*arrowSize);
    ypoints[0] = (int)(fromY - cos*arrowSize);
    xpoints[1] = (int)(toXstick + sin*arrowSize);
    ypoints[1] = (int)(toYstick - cos*arrowSize);
    xpoints[2] = (int)(toX+Math.cos(angle-Math.PI*3/4)*arrowSize*3);
    ypoints[2] = (int)(toY+Math.sin(angle-Math.PI*3/4)*arrowSize*3);
    xpoints[3] = (int)(toX+ cos*arrowSize);
    ypoints[3] = (int)(toY+ sin*arrowSize);
    xpoints[4] = (int)(toX+Math.cos(angle+Math.PI*3/4)*arrowSize*3);
    ypoints[4] = (int)(toY+Math.sin(angle+Math.PI*3/4)*arrowSize*3);
    xpoints[5] = (int)(toXstick-sin*arrowSize);
    ypoints[5] = (int)(toYstick+cos*arrowSize);
    xpoints[6] = (int)(fromX - sin*arrowSize);
    ypoints[6] = (int)(fromY + cos*arrowSize);
    //Polygon arrow = new Polygon(xpoints, ypoints, 7);
    //AffineTransform at = new AffineTransform();
    //at.rotate(angle);
    g2d.setPaint(color);
    //g2d.draw(arrow);
    g2d.drawPolyline(xpoints, ypoints, 7);
    g2d.setPaint(new Color(color.getRed(), color.getGreen(), color.getBlue(), 128));
    g2d.fillPolygon(xpoints, ypoints, 7);
    //g2d.setPaint(new Color(0,0,0));
    //for (int i = 0; i < xpoints.length; i++){
    //	g2d.drawString(String.valueOf(i), xpoints[i], ypoints[i]);
    //}
    //g2d.setPaint(new Color(0,0,0));
    //g2d.drawArc(fromX, fromY, width, height, 0, (int)Math.toDegrees(angle));
