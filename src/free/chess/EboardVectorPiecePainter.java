...
public class EboardVectorPiecePainter extends VectorPiecePainter{
  ...
  public EboardVectorPiecePainter(final Color whiteColor, final Color blackColor){
  ...
  public EboardVectorPiecePainter(final Color whiteColor, final Color blackColor,
                                  final Color whiteOutline, final Color blackOutline){
  ...
  protected Polygon createKingPolygon(int width, int height){
    final Polygon kingPolygon = new Polygon();
  ...
  protected void drawKingImage(Graphics g, int width, int height, Color pieceColor, Color outlineColor){
    ...
    super.drawKingImage(g2, width, height, pieceColor, outlineColor);
    
    
    Stroke pieceStroke = new BasicStroke(2.0f);
    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    g2.setColor(outlineColor);
    g2.setStroke(pieceStroke);
    g2.drawLine(44*width/108,40*height/108,53*width/108,58*height/108);
    g2.drawLine(53*width/108,58*height/108,53*width/108,68*height/108);
    g2.drawLine(62*width/108,40*height/108,53*width/108,58*height/108);
    g2.drawLine(23*width/108,73*height/108,53*width/108,68*height/108);
    g2.drawLine(53*width/108,68*height/108,83*width/108,73*height/108);
    g2.drawLine(24*width/108,92*height/108,53*width/108,86*height/108);
    g2.drawLine(53*width/108,86*height/108,82*width/108,92*height/108);
    g2.dispose();
  }
  ...
  protected Polygon createQueenPolygon(int width, int height){
    final Polygon queenPolygon = new Polygon();
  ...
  protected void drawQueenImage(Graphics g, int width, int height, Color pieceColor, Color outlineColor){
    ...
    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    g2.setColor(outlineColor);
    g2.drawLine(19*width/108,95*height/108,53*width/108,88*height/108);
    g2.drawLine(53*width/108,88*height/108,87*width/108,95*height/108);
    g2.drawLine(25*width/108,83*height/108,53*width/108,76*height/108);
    g2.drawLine(53*width/108,76*height/108,81*width/108,83*height/108);
    g2.dispose();
  }
  ...
  protected Polygon createRookPolygon(int width, int height){
    final Polygon rookPolygon = new Polygon();
  ...
  protected Polygon createBishopPolygon(int width, int height){
    final Polygon bishopPolygon = new Polygon();
  ...
  protected Polygon createKnightPolygon(int width, int height){
    final Polygon knightPolygon = new Polygon();
  ...
  protected Polygon createPawnPolygon(int width, int height){
    final Polygon pawnPolygon = new Polygon();
