...
public class ConsoleTextField extends FixedJTextField{
  ...
  /**
   * String that is added to every issued command. Needs to be carefully crafted.
   */

   private String commandPrefix = "";

    /**
     * A component that will supply prefix for commands to this text field.
     */

    private JTextField prefixSupplier = null;
  ...
  /**
   * Constructor for ConsoleTextField that sends only one type of server commands.
   */

    public ConsoleTextField(Console console, String serverCommand){
    this.console = console;
    this.commandPrefix = serverCommand;
        ...
        case KeyEvent.VK_UP:
          if (evt.getModifiers() == 0){
            ...
            while (++newHistoryIndex < history.size()){
              String historyItem = (String)history.get(newHistoryIndex);
            ...
            setText((String)history.get(currentHistoryIndex));
          }
          break;
  ...
  protected void configurePopup(){
    ...
    /**
     * Method that sets the command prefix.
     */

    public void setCommandPrefix(String s){
        this.commandPrefix = s;
    }

    protected String getCommandPrefix(){
       /* String prefix = prefixSupplier.getText();
        return prefix;*/
