...
public class ConsoleManager extends Plugin implements PlainTextListener, ChatListener, ConnectionListener, GameListListener {
    ...
    /**
     * Split pane holding console and new console panel
     */
    ...
    private void openConsole() {
        ...
        chanGameNumberInput = getChanGameNrInput();
        ...
        splitPane.setDividerLocation(getPrefs().getInt("newconsole-panel-visible"));
    ...
    public void openNewConsole(String text) {
     ...
     public void openNewConsole(String prefix, String nameForConsole, String typeForConsole){
        ...
        containersToConsoles.put(newConsoleContainer, newConsole);
        typesToConsoles.put(typeForConsole.trim(), newConsole);
    ...
    public void saveState() {
        if (getConn()instanceof GameListConnection) {
            ...
            switch (getGameListsDisplayStyle()) {
                case EMBEDDED_GAME_LISTS:
                    displayStyleString = "embedded";
                    break;
                case EXTERNAL_GAME_LISTS:
                    displayStyleString = "framed";
                    break;
                case NO_GAME_LISTS:
                    displayStyleString = "none";
                    break;
                default:
        ...
        getPrefs().setInt("newconsole-panel-visible", splitPane.getDividerLocation());
