...
public abstract class Plugin{
  ...
  public boolean setContext(final PluginContext context){
  ...
  public Preferences getPrefs(){
    if (prefs == null){
      final Preferences pluginPrefs = context.getPreferences(this);
      final Preferences userPrefs = getUser().getPrefs();
  ...
  public Resource [] getResources( final String resourceType){
  ...
  public Resource getResource(final String resourceType, final String resourceId){
  ...
  public PluginUIContainer createContainer(final String id, final int mode){
  ...
  public MemoryFile getFile(final String filename){
  ...
  public void setFile(final String filename, final MemoryFile file){
  ...
  public void setOtherPluginsPaused(final boolean isPaused){
    final Plugin [] plugins = context.getPlugins();
  ...
  public JinAction getAction(final String id){
  ...
  public void exportAction(final JinAction action){
