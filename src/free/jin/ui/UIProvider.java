...
public interface UIProvider{
  ...
  void stop();
    ...
    /**
     * This method is called to remove PluginUIContainer from containers table and
     * thus allows to close and open container with the same id.
     * @param plugin
     * @param id
     * @param container
     */
  void removePluginContainer(Plugin plugin, String id, AbstractPluginUIContainer container);
