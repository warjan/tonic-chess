...
public class OptionPanel extends DialogPanel{
  ...
  public static void error(Component hintParent, String title, String message){
  ...
  public static Object confirm(Component hintParent, String title, String message, Object defaultOption){
  ...
  public static Object confirm(String title, String message, Object defaultOption){
    return confirm(null, title, message, defaultOption);
  }
  ...
  public static Object question(Component hintParent, String title, String message, Object defaultOption){
    OptionPanel panel = new OptionPanel(hintParent, OptionPanel.QUESTION, title,
  ...
  public static Object question(String title, String message, Object defaultOption){
    return question(null, title, message, defaultOption);
  }
