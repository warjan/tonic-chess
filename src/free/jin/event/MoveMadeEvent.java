...
public class MoveMadeEvent extends GameEvent{
  ...
  /**
   * Holds a name of currently moving player.
   */
  ...
  /**
   * Creates a new <code>MoveMadeEvent</code> with current player's name passed on.
   */

    public MoveMadeEvent(Connection conn, Game game, Move move, boolean isNew, String currentPlayerName){
    super(conn, game);
  ...
  /**
   * Returns moving player's name.
   */

  public String getMovingPlayersName(){
