...
public class DeltaBoardStruct extends Struct{
  ...
  public DeltaBoardStruct(final int gameNumber, final int pliesPlayedCount, final String moveAlgebraic,
      final String moveSmith, final int takenTime, final int remainingTime){
  ...
  public static DeltaBoardStruct parseDeltaBoardLine(final String line){
    ...
    final int pliesPlayedCount = Integer.parseInt(tokens.nextToken()); // The amount of plies played

    final String moveAlgebraic = tokens.nextToken(); // The move in algebraic format
    final String moveSmith = tokens.nextToken(); // The move in smith-warren format

    final int takenTime = Integer.parseInt(tokens.nextToken()); // The amount of time taken to make the move
    final int remainingTime = Integer.parseInt(tokens.nextToken()); // The amount of time remaining
