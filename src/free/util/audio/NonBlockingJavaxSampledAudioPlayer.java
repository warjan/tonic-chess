...
/**
 * A subclass of <code>JavaxSampledAudioPlayer</code> which tries to release
 * the audio device when it's not needed by closing the data line.
 * This is needed because on some Linux systems, not closing the data line
 * prevents other programs from using the audio device.  
 */

public class NonBlockingJavaxSampledAudioPlayer extends JavaxSampledAudioPlayer{
